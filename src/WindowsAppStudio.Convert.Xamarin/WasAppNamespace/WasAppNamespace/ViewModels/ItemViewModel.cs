...
{
    public class ItemViewModel : ObservableBase, ISyncItem<ItemViewModel>//, IObservableEntityData
    {
        /*
...
#else
                toStringResult += "NarrationTitle".StringResource() + ". ";
#endif
...
#else
                toStringResult += "NarrationSubTitle".StringResource() + ". ";
#endif
