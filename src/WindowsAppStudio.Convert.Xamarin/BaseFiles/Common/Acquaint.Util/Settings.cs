...
namespace Acquaint.Util
{
	...
	public static class Settings
	{
        ...
        private const string DescriptionFontSizeKey = "description_font_size_key";
        public static readonly double DescriptionFontSizeDefaultNotNull = 18d;

        public static double? DescriptionFontSizeDefault { get; set; }
	    ...
	    public static double DescriptionFontSize
        {
            get
            {
                return AppSettings.GetValueOrDefault<double>(DescriptionFontSizeKey, DescriptionFontSizeDefault ?? DescriptionFontSizeDefaultNotNull);
            }
            set
            {
                AppSettings.AddOrUpdateValue<double>(DescriptionFontSizeKey, value);
            }
        }
